...
public class WebSiteNavigation {
	...
	/*
	 * User navigates before Login - Automate the steps to navigate to pages without
	 * performing Login - Selenium Webdriver commands are used to identify the
	 * elements
	 */
	...
	/*
	 * Verification Point - Verify the page title must contain expected text
	 */
	...
	/*
	 * User navigates after Login - Automate the steps to navigate to pages after
	 * performing Login - Selenium Webdriver commands are used to identify the
	 * elements
	 */
